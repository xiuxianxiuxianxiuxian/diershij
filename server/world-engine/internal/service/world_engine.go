...
func worldEventToProto(e *types.WorldEvent) *cultivation.WorldEvent {
...
func worldStateToProto(s *types.WorldState) *cultivation.WorldState {
	...
	events := make([]*cultivation.WorldEvent, 0, len(s.ActiveEvents))
