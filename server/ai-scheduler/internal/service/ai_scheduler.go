...
func (s *AISchedulerService) callLLM(ctx context.Context, req *cultivation.DecisionRequest, profile *NPCProfile) *cultivation.DecisionResponse {
...
func (s *AISchedulerService) defaultDecision(availableActions []string) *cultivation.DecisionResponse {
